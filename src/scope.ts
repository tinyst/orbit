...
import type { OrbitComponent, OrbitComponentLoader, OrbitDispose, OrbitRefHook, OrbitScope, OrbitScopeController, OrbitStateHook } from "./types.js";

export function createScope(loader: OrbitComponentLoader, root: Element): OrbitScopeController {
