...
export function defineComponent(instantiate) {
    return defineScope((root) => createComponent(root, instantiate));
}
function createComponent(root, instantiate) {
    ...
    const elementController = (element) => {
        ...
        const onAdd = (element) => {
            ...
            for (const attribute of element.attributes) {
                if (attribute.name.startsWith("o-on")) {
                    ...
                    if (event) {
                        let handler = instance[attribute.value];
